    ...
    <section id="contact" className="py-20 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          ¿Listos para construir un proyecto? ¡Déjame un mensaje!
          </motion.p>
        </motion.div>
            ...
            <div className="glass-card p-8 rounded-2xl">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-gray-300 font-medium">Gmail</p>
                    <p className="text-gray-400">facuaguirrez46@gmail.com</p>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-700">
                <p className="text-gray-400 mb-4">Encuéntrame en las plataformas sociales:</p>
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 pointer-events-none group-hover:pointer-events-auto">
                <div className="text-center space-y-8 p-8">
                  ...
                  <div className="space-y-4">
                    ...
                    Espera, ¿quién usa formularios hoy en día?
                    </h3>
                    <p className="text-gray-300 text-lg">¡Lo mantengamos simple y moderno!</p>
                  </div>

                  {/* Big Email Button */}
                  <motion.a
                    href="mailto:facuaguirrez46@gmail.com"
                  ...
                  {/* Social Links */}
                  <div className="space-y-4">
                    <p className="text-gray-400">O encuéntrame en:</p>
                    <div className="flex justify-center space-x-6">
                      {[
                        ...
                        <motion.a
                          ...
                          whileTap={{ scale: 0.9 }}
                          className={`flex flex-col items-center space-y-2 p-4 bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 hover:border-cyan-500 transition-all duration-300 text-gray-400 ${color} group/social`}
                        >
                  ...
                  {/* Fun Footer */}
                  <p className="text-gray-500 text-sm italic">"Because clicking is easier than typing"</p>
                </div>
              </div>
            </div>
          </motion.div>
